...
<div class="row">
	...
	<div class="four columns text-center l-margin-bm">
		...
		<p>#d47600<br>rgb (212, 118, 0)</p>
	</div>
	<div class="four columns text-center l-margin-bm">
		<p><i class="icon--xl icon--circle" style="padding:1.5em; background-color:#9c6114;"></i></p>
		<p>#9c6114<br>rgb (156, 97, 20)</p>
	</div>
</div>
<div class="row">
	<div class="four columns text-center l-margin-bm">
	...
	<div class="four columns text-center l-margin-bm">
		...
		<p>#d7a900<br>rgb (215, 169, 0)</p>
	</div>
</div>
<div class="row">
	<div class="four columns text-center l-margin-bm">
		<p><i class="icon--xl icon--circle" style="padding:1.5em; background-color:#dad7cb;"></i></p>
		<p>#dad7cb<br>rgb (218, 215, 203)</p>
	</div>
	<div class="four columns text-center l-margin-bm">
		<p><i class="icon--xl icon--circle" style="padding:1.5em; background-color:#cac0b6;"></i></p>
		<p>#cac0b6<br>rgb (202, 292, 182)</p>
	</div>
	<div class="four columns text-center l-margin-bm">
		<p><i class="icon--xl icon--circle" style="padding:1.5em; background-color:#bdb1a6;"></i></p>
		<p>#bdb1a6<br>rgb (189, 177, 166)</p>
	</div>
</div>
<div class="row">
	<div class="four columns text-center l-margin-bm">
		<p><i class="icon--xl icon--circle" style="padding:1.5em; background-color:#e0e1dd;"></i></p>
		<p>#e0e1dd<br>rgb (224, 225, 221)</p>
	</div>
	<div class="four columns text-center l-margin-bm">
		<p><i class="icon--xl icon--circle" style="padding:1.5em; background-color:#adafaf;"></i></p>
		<p>#adafaf<br>rgb (173, 175, 175)</p>
	</div>
	<div class="four columns text-center l-margin-bm">
		<p><i class="icon--xl icon--circle" style="padding:1.5em; background-color:#747678;"></i></p>
		<p>#747678<br>rgb (116, 118, 120)</p>
	</div>
</div>
<div class="row">
	<div class="four columns text-center l-margin-bm">
		<p><i class="icon--xl icon--circle" style="padding:1.5em; background-color:#d1d4d3;"></i></p>
		<p>#d1d4d3<br>rgb (209, 212, 211)</p>
	</div>
	<div class="four columns text-center l-margin-bm">
	...
	<div class="four columns text-center l-margin-bm">
		...
		<p>#1b242a<br>rgb (27, 36, 42)</p>
	</div>
</div>
					
                </div>

                <div id="website" class="l-container">
                    <div class="row l-margin-bm">
                        <div class="twelve columns">
                            <h2>Website-only Colors</h2>
                        </div>
                    </div>
...
<div class="row">
	<div class="four columns text-center l-margin-bm">
		<p><i class="icon--xl icon--circle" style="padding:1.5em; background-color:#656667;"></i></p>
		<p>#656667<br>rgb (101, 102, 103)<br><span class="fine-print">gray</span></p>
	</div>
	<div class="four columns text-center l-margin-bm">
		<p><i class="icon--xl icon--circle" style="padding:1.5em; background-color:#333332;"></i></p>
		<p>#333332<br>rgb (51, 51, 50)<br><span class="fine-print">charcoal</span></p>
	</div>
	<div class="four columns text-center l-margin-bm">
		<p><i class="icon--xl icon--circle" style="padding:1.5em; background-color:#222222;"></i></p>
		<p>#222222<br>rgb (34, 34, 34)<br><span class="fine-print">off-black </span></p>
	</div>
</div>  
<div class="row">
	<div class="four columns text-center l-margin-bm">
	...
	<div class="four columns text-center l-margin-bm">
		<p><i class="icon--xl icon--circle" style="padding:1.5em; background-color:#ee3228;"></i></p>
		<p>#ee3228<br>rgb (238, 50, 40)<br><span class="fine-print">pomegranate</span></p>
	</div>
	<div class="four columns text-center l-margin-bm">
