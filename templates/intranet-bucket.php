...
<div class="hero__slides hero__slides--secondary fine-print">
	<div class="l-constrained--site row">
		<div class="main__message main__message--transparent">
			<h1 class="main__heading">Bucket Page</h1>
		</div>
...
<div class="l-constrained l-constrained--main l-padding-mobile-hd background-white" role="main">
	...
	<main role="main" style="margin-top:0;">
		...
		<div class="l-constrained l-padding-mobile-hd background-white">
			<div class="l-container l-padding-hd l-padding-vm">
				<div class="row">
					...
					<div class="four columns">
						<img src="/assets/dist/img/card-img-1.jpg">
					</div>
				</div>
...
<div id="headline-only" class="l-container l-padding-hd l-padding-bs">
	...
	<div class="card__container l-margin-td">
		...
		<div class="card__wrap">
			...
			<div class="l-container background-off-white l-padding-hd l-padding-vm">
				<div class="row">
