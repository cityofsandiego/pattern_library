...
$(".tabs-list__item, .tabs__bucket").removeClass("is-active");
$menuChildren = $(".l-container").find('a[href="#'+a+'"]');
$li = $($menuChildren).closest("li");
$li.addClass('is-active');
$("div#"+a).addClass('is-active');
        }
change_tab( $.urlParam('tab') );
});
</script>	
