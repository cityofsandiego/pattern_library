...
<body class="insidesd node-type-article">
                ...
                <div class="l-constrained">
                    <div class="row">
                        <div class="sm-six six columns no-gutters">
                            ...
                            <p><a href="/templates/"><img src="https://www.sandiego.gov/sites/all/themes/sandiego/assets/dist/img/logo-mark-blue.png" width="auto" height="30"></a></p>
</div>
<div class="sm-nine eleven columns">
<p class="l-padding-ts"><a href="/templates/">sandiego.gov</a></p>
</div>
</div>
                        </div>
                        <div class="sm-six six columns no-gutters">
							<p class="hide-on-desktop"><a href="#" class="search-icon translate-icon--open l-padding-tn"><i class="icon-translate"></i></a></p>
